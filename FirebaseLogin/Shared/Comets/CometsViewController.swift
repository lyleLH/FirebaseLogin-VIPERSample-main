...
class CometsViewController: UIViewController {
    
    var backgroundLayer = Gradients.amourAmour.layer
    let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Plan Your Training!"
    ...
    override func viewDidLoad() {
        ...
        let comets = [Comet(startPoint: CGPoint(x: 100, y: 0),
                      ...
                      Comet(startPoint: CGPoint(x: 0.8 * width, y: 0),
                            endPoint: CGPoint(x: 0.95 * width, y: height),
                            lineColor: UIColor.red.withAlphaComponent(0.2),
                            cometColor: UIColor.red),
